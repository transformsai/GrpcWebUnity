...
internal class WebGLCall : CallInvoker
{
    ...
    private void SubmitCall<TRequest, TResponse>(Method<TRequest, TResponse> method, string host, CallOptions options, TRequest request)
    {
        ...
        var areValidTypes = iMessageType.IsAssignableFrom(_requestType) && iMessageType.IsAssignableFrom(_responseType);
